...
void inline DMACopyCH0(void* source, void* dest, u32 WordCount, u32 mode) {
...
void inline DMACopyCH1(void* source, void* dest, u32 WordCount, u32 mode) {
    REG_DMA1SAD = (u32)source;
    REG_DMA1DAD = (u32)dest;
    REG_DMA1CNT = WordCount | mode;
}

void inline DMACopyCH2(void* source, void* dest, u32 WordCount, u32 mode) {
    REG_DMA2SAD = (u32)source;
    REG_DMA2DAD = (u32)dest;
    REG_DMA2CNT = WordCount | mode;
}

void inline DMACopyCH3(void* source, void* dest, u32 WordCount, u32 mode) {
...
void inline DMAClearMemory16(void* dest, u32 WordCount) {
...
void inline DMAClearMemory32(void* dest, u32 WordCount) {
