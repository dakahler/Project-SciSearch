/// Note by me:
/// This is a pretty standard header file for the SDK. Sets up lots of
/// register definitions, etc. Some parts have been modified and added to,
/// but for the most part it is the same. Here is the original header comment:
...
#ifndef DMA_C
extern void DMACopy(u8 channel, void* source, void* dest, u32 WordCount, u32 mode);
#endif
